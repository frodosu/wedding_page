                ...
                var t = setTimeout(function () {
                    $('[data-countdown]').each(function () {
                        ...
                        $this.countdown(finalDate, function (event) {
                            $this.html(event.strftime('<div class="countdown-container"><div class="countdown-box"><div class="number">%-D</div><span>天</span></div>' + '<div class="countdown-box"><div class="number">%H</div><span>小時</span></div>' + '<div class="countdown-box"><div class="number">%M</div><span>分</span></div>' + '<div class="countdown-box"><div class="number">%S</div><span>秒</span></div></div>'));
                        });
                    });
                }, 300);
            }
